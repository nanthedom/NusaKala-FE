...
export default function NusaCamPage() {
    ...
    const predictBatik = async () => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/predict/batik`, {
                method: "POST",
                body: formData,
            })
            ...
            if (!result.motif || typeof result.confidence !== "number") {
        ...
        <div className="min-h-screen bg-gradient-to-br from-nusa-gold/5 to-nusa-bronze/5">
            <div className="container mx-auto px-4 py-4 max-w-7xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <Card className="border-nusa-gold/20 shadow-lg overflow-hidden">
                        <CardHeader className="bg-gradient-to-r from-nusa-gold/10 to-nusa-bronze/10 p-3 sm:p-4 lg:p-6">
                        ...
                        <CardContent className="p-3 sm:p-4 lg:p-6">
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    ...
                                    <div className="flex flex-col gap-2 sm:gap-3">
                                        <Button
                                            ...
                                            className="w-full bg-nusa-bronze hover:bg-amber-600 text-white py-3 sm:py-4 text-sm sm:text-base md:text-lg font-semibold min-h-[44px] touch-manipulation"
                                        >
                                            {!cameraReady ? (
                                                <>
                                        ...
                                        <Button
                                            onClick={stopCamera}
                                            variant="outline"
                                            className="w-full border-red-300 text-red-600 hover:bg-red-50 bg-transparent text-xs sm:text-sm md:text-base min-h-[44px] touch-manipulation"
                                        >
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    <div className="relative">
                                        ...
                                        <Button
                                            ...
                                            variant="outline"
                                            size="sm"
                                            className="absolute top-2 right-2 bg-white/90 hover:bg-white p-1.5 sm:p-2 min-h-[32px] min-w-[32px] touch-manipulation"
                                        >
                                    ...
                                    <div className="space-y-2 sm:space-y-3">
                                        <Button
                                            ...
                                            disabled={isLoading}
                                            className="w-full bg-nusa-gold hover:bg-nusa-bronze text-white py-3 sm:py-4 text-sm sm:text-base md:text-lg font-semibold min-h-[44px] touch-manipulation"
                                        >
                                            {isLoading ? (
                                                <>
                                                    <Loader2 className="w-4 h-4 sm:w-5 sm:h-5 mr-2 animate-spin flex-shrink-0" />
                                        ...
                                        <div className="grid grid-cols-2 gap-2 sm:gap-3">
                                            <Button
                                                onClick={startCamera}
                                                variant="outline"
                                                className="border-nusa-bronze text-nusa-bronze hover:bg-nusa-bronze/10 bg-transparent text-xs sm:text-sm md:text-base min-h-[44px] touch-manipulation"
                                            >
                                            ...
                                            <Button
                                                ...
                                                variant="outline"
                                                className="border-nusa-gold text-nusa-gold hover:bg-nusa-gold/10 text-xs sm:text-sm md:text-base min-h-[44px] touch-manipulation"
                                            >
                            ...
                            {!selectedImage && !isCameraActive && (
                                <div className="space-y-4 sm:space-y-6">
                                    ...
                                    <div
                                        className="border-2 border-dashed border-nusa-gold/30 rounded-lg p-4 sm:p-6 lg:p-8 text-center hover:border-nusa-gold/50 transition-colors cursor-pointer min-h-[120px] sm:min-h-[140px] flex flex-col items-center justify-center touch-manipulation"
                                        onClick={() => fileInputRef.current?.click()}
                                    >
                                    ...
                                    <Button
                                        onClick={startCamera}
                                        className="w-full bg-nusa-bronze hover:bg-amber-600 text-white py-3 sm:py-4 lg:py-5 text-sm sm:text-base lg:text-lg font-semibold min-h-[44px] touch-manipulation"
                                    >
                                        <Camera className="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" />
                    ...
                    {/* Results Section */}
                    <Card className="border-nusa-gold/20 shadow-lg overflow-hidden">
                        <CardHeader className="bg-gradient-to-r from-nusa-green/10 to-nusa-gold/10 p-3 sm:p-4 lg:p-6">
                            <CardTitle className="flex items-center justify-center gap-2 text-nusa-darkBrown text-sm sm:text-base md:text-lg lg:text-xl">
                        ...
                        <CardContent className="p-3 sm:p-4 lg:p-6">
                                ...
                                <div className="text-center py-6 sm:py-8 lg:py-12">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center px-2 sm:px-0">
                                        <Button
                                            ...
                                            className="bg-nusa-bronze hover:bg-amber-600 text-white text-xs sm:text-sm lg:text-base min-h-[44px] touch-manipulation"
                                        >
                                        ...
                                        <Button
                                            onClick={resetAll}
                                            variant="outline"
                                            className="border-nusa-gold text-nusa-darkBrown hover:bg-nusa-gold/10 text-xs sm:text-sm lg:text-base bg-transparent min-h-[44px] touch-manipulation"
                                        >
                            ...
                            {prediction && !predictionError && (
                                <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                                    {/* Motif Name & Confidence */}
                                    <div className="text-center pb-3 sm:pb-4 border-b border-nusa-gold/20">
                                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-nusa-darkBrown mb-2 sm:mb-3 break-words leading-tight">
                                            {prediction.motif}
                                        </h3>
                                        <Badge
                                            className={`${getConfidenceColor(prediction.confidence)} px-2 sm:px-3 lg:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium`}
                                        >
                                            Tingkat Akurasi: {(prediction.confidence * 100).toFixed(1)}%
                                        </Badge>
                                    </div>

                                    {/* Origin */}
                                    <div className="bg-gradient-to-r from-nusa-gold/10 to-nusa-bronze/10 p-3 sm:p-4 rounded-lg border border-nusa-gold/20">
                                        <h4 className="font-semibold text-nusa-darkBrown mb-2 flex items-center gap-2 text-xs sm:text-sm lg:text-base">
                                            <div className="w-2 h-2 bg-nusa-gold rounded-full flex-shrink-0"></div>
                                    ...
                                    {/* Description */}
                                    <div className="bg-gradient-to-r from-nusa-green/10 to-nusa-gold/10 p-3 sm:p-4 rounded-lg border border-nusa-green/20">
                                        <h4 className="font-semibold text-nusa-darkBrown mb-2 flex items-center gap-2 text-xs sm:text-sm lg:text-base">
                                            <div className="w-2 h-2 bg-nusa-green rounded-full flex-shrink-0"></div>
                                            <span>Deskripsi Motif</span>
                                        </h4>
                                        <p className="text-nusa-brown leading-relaxed text-xs sm:text-sm lg:text-base break-words">
                                    ...
                                    <div className="bg-gradient-to-r from-nusa-bronze/10 to-nusa-gold/10 p-3 sm:p-4 rounded-lg border border-nusa-bronze/20">
                                        <h4 className="font-semibold text-nusa-darkBrown mb-2 flex items-center gap-2 text-xs sm:text-sm lg:text-base">
                                            <div className="w-2 h-2 bg-nusa-bronze rounded-full flex-shrink-0"></div>
                                            <span>Makna Budaya</span>
                                        </h4>
                                        <p className="text-nusa-brown leading-relaxed text-xs sm:text-sm lg:text-base break-words">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
                                        <Button
                                            ...
                                            variant="outline"
                                            className="flex-1 border-nusa-gold text-nusa-darkBrown hover:bg-nusa-gold/10 text-xs sm:text-sm lg:text-base min-h-[44px] touch-manipulation"
                                        >
                                            <Download className="w-4 h-4 mr-2 flex-shrink-0" />
                                            <span className="truncate">Simpan Hasil</span>
                                        </Button>
                                        <Button
                                            onClick={resetAll}
                                            className="flex-1 bg-nusa-bronze hover:bg-amber-600 text-white text-xs sm:text-sm lg:text-base min-h-[44px] touch-manipulation"
                                        >
                                            <RotateCcw className="w-4 h-4 mr-2 flex-shrink-0" />
